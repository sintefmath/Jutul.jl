...
const coeff1_refOCP = Polynomial([ -4.656   , 
    0        , 
+ 88.669 , 
0        , 
- 401.119, 
...
const coeff2_refOCP =Polynomial([ -1      , 
0       , 
+ 18.933, 
0       , 
- 79.532, 
...
0       , 
+ 95.960]);
const coeff1_dUdT = Polynomial([0.199521039        , 
- 0.928373822      , 
+ 1.364550689000003, 
- 0.611544893999998]);

const coeff2_dUdT = Polynomial([1  , 
- 5.661479886999997, 
+ 11.47636191      ,  
- 9.82431213599998 , 
+ 3.048755063])
...
##
const coeff1 = Polynomial([0.005269056 ,
        + 3.299265709,
        - 91.79325798,
        + 1004.911008,
        - 5812.278127,
