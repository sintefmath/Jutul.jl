...
export select_secondary_variables_domain!, select_secondary_variables_system!, select_secondary_variables_formulation!
...
select_secondary_variables!(svars, ::FullyImplicit, model) = nothing
...
select_parameters!(prm, ::FullyImplicit, model) = nothing
...
select_equations!(eqs, ::FullyImplicit, model) = nothing

function set_minimum_output_variables!(model)
    ...
    set_minimum_output_variables!(outputs, model.domain, model)
    set_minimum_output_variables!(outputs, model.system, model)
    set_minimum_output_variables!(outputs, model.formulation, model)
end

set_minimum_output_variables!(outputs, ::Any, model) = nothing
...
function select_output_variables!(model, output_level = :primary_variables)
    set_minimum_output_variables!(model)
    outputs = model.output_variables
